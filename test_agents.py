...
print("✓ Agent 1 working" if entities.get("loom_id") else "✗ Agent 1 failed")
...
print("✓ Agent 2 working" if anomalies['anomaly_count'] > 0 else "✗ Agent 2 failed")
...
print("✓ Agent 3 working" if len(retrieved) > 0 else "✗ Agent 3 failed")

# ── Test Agent 4: Synthesis with Ollama ───────────────────────────────────────────
print("\n4. Testing Agent 4 (Synthesis with Ollama)...")
print("Note: Make sure Ollama is running with: ollama run mistral")
try:
...
print("=" * 80)
print("\nSummary:")
print("Agent 1 (Entity Extraction): ✓ Working")
print("Agent 2 (Anomaly Detection): ✓ Working")
print("Agent 3 (Retrieval): ✓ Working")
print("Agent 4 (Synthesis): Requires Ollama to be running")
